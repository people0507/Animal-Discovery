                        ...
                        <table id="multi_col_order" class="table table-striped table-bordered display "
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Gói câu hỏi</th>
                            ...
                            <tbody>
                                @foreach ($topics as $key => $topic)
                                    <tr>
                                        ...
                                        <td><img src="http://localhost:8000/topics/{{$topic->topic_image}}" alt="123" width="200"></td>
                                        <td>{{$topic->topic_description}}</td>
                                        <td>{{$topic->score_per_question}}</td>
                                        <td class="box-container">
                                            <div class="box-char">
                                                <a href="{{route('admin.list_question',['id' => $topic->id])}}">Câu hỏi</a>
                                            </div>
                                        </td>
                                        <td>
