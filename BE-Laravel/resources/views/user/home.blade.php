              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="{{asset('users/img/animal-md-1.jpg')}}" alt="" />
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="row g-4">
              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="{{asset('users/img/animal-md-2.jpg')}}" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="row g-4">
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    <img class="img-fluid" src="{{asset('users/img/animal-md-3.jpg')}}" alt="" />
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">Animal</p>
                      <h5 class="text-white mb-0">Elephant</h5>
                    </div>
        ...
        >
          <div class="testimonial-item text-center">
            <img
              ...
              src="{{asset('users/img/testimonial-1.jpg')}}"
          ...
          <div class="testimonial-item text-center">
            <img
              class="img-fluid rounded-circle border border-2 p-2 mx-auto mb-4"
              src="{{asset('users/img/testimonial-2.jpg')}}"
              style="width: 100px; height: 100px"
            />
            <div class="testimonial-text rounded text-center p-4">
              <p>
          ...
          <div class="testimonial-item text-center">
            <img
              class="img-fluid rounded-circle border border-2 p-2 mx-auto mb-4"
              src="{{asset('users/img/testimonial-3.jpg')}}"
              style="width: 100px; height: 100px"
            />
            <div class="testimonial-text rounded text-center p-4">
              <p>
